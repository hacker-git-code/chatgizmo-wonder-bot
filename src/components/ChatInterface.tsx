...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ className }) => {
  ...
  useEffect(() => {
    if (messages.length === 0) {
      handleSendMessage("Hi there! I'm your assistant. How can I help you today?");
    }
  }, []);
  ...
  return (
    <div className={cn("w-full flex flex-col", className)}>
      {/* Chat Messages Area */}
      <div className="flex-1 overflow-y-auto p-4 subtle-scroll rounded-t-2xl glass-morphism">
      ...
      <form 
        ...
        className={cn(
          ...
          isFocused ? "shadow-[0_0_0_2px_rgba(var(--primary)/0.3)]" : ""
        )}
      >
            ...
            {isTyping ? (
              ...
              <>
                ...
                <Button 
                  ...
                  className={cn(
                    "rounded-full bg-primary h-10 w-10 transition-transform duration-300",
